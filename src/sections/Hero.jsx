    ...
    <div className=" hero-wrapper mt-16">   
        <div className="wrapper ">
            <section className="hero lg:max-w-7xl px-7 mx-auto flex flex-wrap lg:justify-start justify-center items-start " id='hero'>
                <div className="heroContent lg:text-start text-center  pt-32 md:pt-56 md:w-1/2">
                    <h1 className='md:text-4xl text-xl font-semibold text-blue-950'>Unlock the power of words with our <br /> expert legislative drafting services. <br />Transform ideas into effective laws <br /> that shape a brighter tomorrow.</h1>
